...
public class GarbageCollectorController {
	...
	// Segun un Username me da un usuario. (33)
		@GetMapping(path = "/api/usuario/user/{name}/")
		public ResponseEntity<Usuario> getUsuario_Username(@PathVariable(value = "name")String name){
			Usuario p = us.findByUsername(name);
			return ResponseEntity.ok(p);
		}
